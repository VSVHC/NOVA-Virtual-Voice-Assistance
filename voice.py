...
image = cv2.imread("sagi.png")
image = cv2.resize(image, (400, 400))
cv2.imshow("NOVA", image)
...
if __name__=='__main__':
    ...
    while True:
        ...
        #         speak(" City Not Found ")
            ...
            speak('I am NOVA Generation 1 , Develop to provide assistance to Humans')
            print('I am NOVA Generation 1 , Develop to provide assistance to Humans')
            ...
            speak('Hello, I am NOVA, your personal assistant. My programming enables me to assist you with various tasks such as'
            ...
            speak("I was created by SaiViswa")
            print("I was created by Sai Viswa")
